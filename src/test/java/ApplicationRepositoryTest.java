...
import java.util.Map;
 ...
 class ApplicationRepositoryTest {
    ...
    void getQuestionRepositoryTest() throws IOException {
        QuestionRepository expected = applicationRepository.getQuestionRepository("questionsList.json");
        Assertions.assertAll(() ->Assertions.assertEquals(expected.findQuestionById(4), questionRepository.findQuestionById(4)),
    ...
    void getAnswerRepository() throws IOException {
        AnswerRepository expected = applicationRepository.getAnswerRepository("answersList.json");
