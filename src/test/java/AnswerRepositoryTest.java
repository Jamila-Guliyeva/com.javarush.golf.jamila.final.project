...
public class AnswerRepositoryTest {
    ...
    @Test
    void getIdToAnswerTest(){
        Map<Integer, Answer> expected = Map.of(2, new Answer("Принять вызов", 2, 4),
                3, new Answer("Отклонить вызов", 3, 10),
                5, new Answer("Подняться на мостик", 5, 9),
                6, new Answer("Отказаться подниматься на мостик", 6, 11),
                9, new Answer("Солгать о себе", 9, 12),
        ...
        Assertions.assertEquals(expected, answerRepository.getIdToAnswer());
    }
